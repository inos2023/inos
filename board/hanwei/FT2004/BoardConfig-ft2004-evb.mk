...
# Uboot defconfig
export INOS_UBOOT_DEFCONFIG=hanwei_ft2004_uboot_defconfig
# Uboot PBF pack path
...
# Kernel defconfig
export INOS_KERNEL_DEFCONFIG=hanwei_ft2004_defconfig
# Kernel defconfig fragment
export INOS_KERNEL_DEFCONFIG_FRAGMENT=
# Kernel dts
export INOS_KERNEL_DTS=ft2004-devboard-d4-dsk
...
# Buildroot config
export INOS_CFG_BUILDROOT=hanwei_ft2004_buildroot_defconfig

# Build jobs
export INOS_JOBS=12
# target chip
export INOS_TARGET_PRODUCT=FT2004
